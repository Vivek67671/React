...
const galleryItems = [
	...
	
	{
		...
		thumbnail: "images/Gallery/gg67.webp",
		type: 'landing-page',
	},
	{
		...
		additionalImages: [
			...
			{ path: "images/Gallery/Fintrack/1 (2).webp", scrollable: true },
			{ path: "images/Gallery/Fintrack/1 (3).webp", scrollable: true },
			{ path: "images/Gallery/Fintrack/1(4).webp", scrollable: true },
			{ path: "images/Gallery/Fintrack/2 (1).webp", scrollable: true },
			{ path: "images/Gallery/Fintrack/2 (2).webp", scrollable: true },
			{ path: "images/Gallery/Fintrack/2 (3).webp", scrollable: true },
			{ path: "images/Gallery/Fintrack/2 (4).webp", scrollable: true },
			{ path: "images/Gallery/Fintrack/3 (1).webp", scrollable: true },
			{ path: "images/Gallery/Fintrack/3 (2).webp", scrollable: true },
			{ path: "images/Gallery/Fintrack/3 (3).webp", scrollable: true },
			{ path: "images/Gallery/Fintrack/3 (4).webp", scrollable: true },
			{ path: "images/Gallery/Fintrack/3 (5).webp", scrollable: true },
			{ path: "images/Gallery/Fintrack/3 (6).webp", scrollable: true },
      { path: "images/Gallery/Fintrack/3().webp", scrollable: true },
      { path: "images/Gallery/Fintrack/3(7).webp", scrollable: true },
            { path: "images/Gallery/Fintrack/Dashboard V1 Responsive - menu.webp", scrollable: true },
			{ path: "images/Gallery/Fintrack/Dashboard V1 Responsive - Notification Page.webp", scrollable: true },
			{ path: "images/Gallery/Fintrack/Dashboard V1 Responsive - Notification Pop-up.webp", scrollable: true },
			{ path: "images/Gallery/Fintrack/Dashboard V1 Responsive - Overview.webp", scrollable: true },
			{ path: "images/Gallery/Fintrack/Dashboard V1 Responsive - Receive.webp", scrollable: true },
			{ path: "images/Gallery/Fintrack/Dashboard V1 Responsive - Statistics.webp", scrollable: true },
			{ path: "images/Gallery/Fintrack/Dashboard V1 Responsive - Transaction - Delete Transaction.webp", scrollable: true },
			{ path: "images/Gallery/Fintrack/Dashboard V1 Responsive - Transaction - Details Transaction.webp", scrollable: true },
			{ path: "images/Gallery/Fintrack/Dashboard V1 Responsive - Transaction - Export Done.webp", scrollable: true },
			{ path: "images/Gallery/Fintrack/Dashboard V1 Responsive - Transaction.webp", scrollable: true },
			{ path: "images/Gallery/Fintrack/Dashboard V1 Responsive - Transaction-1.webp", scrollable: true },
			{ path: "images/Gallery/Fintrack/Dashboard V1 Responsive - Transaction-2.webp", scrollable: true },
			{ path: "images/Gallery/Fintrack/Dashboard V1 Responsive - Transfer.webp", scrollable: true },
			{ path: "images/Gallery/Fintrack/Dashboard V2 - Overview.webp", scrollable: true },
			{ path: "images/Gallery/Fintrack/Dashboard V2 Responsive - Overview.webp", scrollable: true },
			{ path: "images/Gallery/Fintrack/Dashboard V3 - Overview.webp", scrollable: true },
			{ path: "images/Gallery/Fintrack/Dashboard V3 Responsive - Overview.webp", scrollable: true },
			{ path: "images/Gallery/Fintrack/Dashboard V4 - Overview.webp", scrollable: true },
			{ path: "images/Gallery/Fintrack/Dashboard V4 Responsive - Overview.webp", scrollable: true },
			{ path: "images/Gallery/Fintrack/Dashboard V1 - Notification Page.webp", scrollable: true },
			{ path: "images/Gallery/Fintrack/Dashboard V1 - Notification Pop-up.webp", scrollable: true },
			{ path: "images/Gallery/Fintrack/Dashboard V1 - Overview.webp", scrollable: true },
			{ path: "images/Gallery/Fintrack/Dashboard V1 - Receive money.webp", scrollable: true },
			{ path: "images/Gallery/Fintrack/Dashboard V1 - Statistics.webp", scrollable: true },
			{ path: "images/Gallery/Fintrack/Dashboard V1 - Transaction - Delete Transaction.webp", scrollable: true },
			{ path: "images/Gallery/Fintrack/Dashboard V1 - Transaction - Details Transaction.webp", scrollable: true },
			{ path: "images/Gallery/Fintrack/Dashboard V1 - Transaction - Export Date.webp", scrollable: true },
			{ path: "images/Gallery/Fintrack/Dashboard V1 - Transaction - Export Done.webp", scrollable: true },
			{ path: "images/Gallery/Fintrack/Dashboard V1 - Transaction - Filter.webp", scrollable: true },
			{ path: "images/Gallery/Fintrack/Dashboard V1 - Transaction.webp", scrollable: true },
			{ path: "images/Gallery/Fintrack/Dashboard V1 - Transfer.webp", scrollable: true },

			{ path: "images/Gallery/Fintrack/Help & Center.webp", scrollable: true },
			{ path: "images/Gallery/Fintrack/Settings - Help & Center Responsive.webp", scrollable: true },
			{ path: "images/Gallery/Fintrack/Settings - Personal info Responsive.webp", scrollable: true },
			{ path: "images/Gallery/Fintrack/Settings - Personal Info.webp", scrollable: true },
			{ path: "images/Gallery/Fintrack/Settings - Preference.webp", scrollable: true },
			{ path: "images/Gallery/Fintrack/Settings - Preferences Responsive.webp", scrollable: true },
			{ path: "images/Gallery/Fintrack/Settings - Security Responsive.webp", scrollable: true },
			{ path: "images/Gallery/Fintrack/Settings - Security.webp", scrollable: true },
			{ path: "images/Gallery/Fintrack/Wallet Responsive - Edit Details Card.webp", scrollable: true },
			{ path: "images/Gallery/Fintrack/Wallet Responsive.webp", scrollable: true },
			{ path: "images/Gallery/Fintrack/Wallet Responsive-1.webp", scrollable: true },
			{ path: "images/Gallery/Fintrack/Wallets -  Details Card.webp", scrollable: true },
			{ path: "images/Gallery/Fintrack/Wallets - Add new Card.webp", scrollable: true },
			{ path: "images/Gallery/Fintrack/Wallets.webp", scrollable: true },
